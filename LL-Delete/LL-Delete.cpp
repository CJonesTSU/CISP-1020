...
void delNode(Node** start, int delNum)
{
    ...
    *   Local Variables
    ****************************/
    bool found = false;         // have we found our node??
    Node* current = *start;     // ptr to our current node
    Node* temp;                 // the node to be removed
    
    
    if(current->getNumber() == delNum)
    {
        //first node is our number
        cout << "found value at first node" << endl;
        cout << "removing node: " << endl;
        current->display();
        current->getNext()->setPrev(0);
    ...
    if (found == false)
    {
	    ...
	    {
            // this gets us to the node after our deletion point or the end of the list
            current = current->getNext(); 
        }
        //check if we are at the last node
        if((current->getNext()==NULL) && current->getNumber()==delNum)
        {
            // remove last node
            cout << "found value at last node" << endl;
            cout << "removing node: " << endl;
            current->display();
        ...
        if((current->getNext()!=NULL) && (current->getNumber()==delNum))
        {
            // found our value mid list
            cout << "found the value in mid list" << endl;
            cout << "removing node: " << endl;
            current->display();
    ...
    if (found==false)
    {
        ...
        cout << "value: " << delNum << " was not found in the list." << endl;
    }
}
...
void testDelNode(Node** pps)
{
    cout << "in testDelNode" << endl;
    cout << "testing remove inital node" << endl;
    ...
    cout << "testing remove noexistant node" << endl;
    cout << "initial list" << endl;
    traverse(pps);
    delNode(pps,6);
    cout << "ending list" << endl;
    ...
    cout << "testing remove mid-list node" << endl;
    cout << "initial list" << endl;
    traverse(pps);
    delNode(pps,7);
    cout << "ending list" << endl;
    ...
    cout << "testing remove final node" << endl;
    cout << "initial list" << endl;
    traverse(pps);
    delNode(pps,13);
    cout << "ending list" << endl;
