...
{
   float volume;
   volume = 4.0 / 3.0 * PI * (radiusIn * radiusIn * radiusIn);
   return volume;
}
...
{
   float area;
   area = ((2 * PI * radiusIn * radiusIn)) + ((heightIn * PI * radiusIn * 2));
   return area;
}
...
{
   float volume;
   volume = PI * (radiusIn * radiusIn) * heightIn;
   return volume;
}
...
{
   float volume;
   volume = ((PI * radiusIn * radiusIn * heightIn)) * ((.3333333333));
   return volume;
}
